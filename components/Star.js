...
const Star = ({ offset, size, distance = 0 }) => {
  return (
    <Svg
      style={{ marginHorizontal: distance || 0 }}
      width={size}
      height={size}
      viewBox="0 0 988 941">
      <Defs>
        <LinearGradient id="grad" x1="0" y1="0" x2="1" y2="0">
          <Stop offset={offset} stopColor="#FFD080" stopOpacity="1" />
          <Stop offset={offset} stopColor="grey" stopOpacity="1" />
        </LinearGradient>
      </Defs>
